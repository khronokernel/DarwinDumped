 ...
 *
 * Disassembly of dsdt.dat, Thu May 28 18:35:45 2009
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005566 (21862)
 ...
 */
DefinitionBlock ("dsdt.aml", "DSDT", 1, "APPLE ", "iMac", 0x00090001)
{
    External (PDC1)
    External (PDC0)
        ...
        Device (PCI0)
        {
            ...
            Device (RP01)
            {
                ...
                Device (GFX0)
                {
                    ...
                    OperationRegion (ACTL, SystemIO, 0x0800, 0x0100)
                    Field (ACTL, DWordAcc, NoLock, Preserve)
                    {
                        BANK,   32, 
                                Offset (0x98), 
                        PCS0,   32, 
                    ...
                    Method (PWRD, 1, NotSerialized)
                    {
                        ...
                        Else
                        {
                            ...
                            Store (0xFFFF, PCS0)
                            Store (PAC0, Local0)
                            Store (And (Local0, 0xFFFFFFFE), PAC0)
                            Store (Local1, PCS0)
                            Store (Local0, BANK)
                        }
                    }

                    OperationRegion (DXF0, PCI_Config, 0x0400, 0xFF)
                    Field (DXF0, ByteAcc, NoLock, Preserve)
                    {
                                Offset (0x1C), 
                        DMAF,   32
                    }
                    ...
                    {
                        Store (DMAF, Local0)
                        And (Local0, 0xFFFFFF80, Local0)
                        Or (Local0, 0x75, Local0)
                        Store (Local0, DMAF)
                    }
