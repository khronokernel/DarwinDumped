 ...
 *
 * Disassembly of ssdt.dat, Thu May 28 18:39:36 2009
 *
 *
 ...
 */
DefinitionBlock ("ssdt.aml", "SSDT", 0, "", "SataAhci", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.SATA)
    {
        ...
        Device (PRT1)
        {
            ...
            Method (_PS0, 0, Serialized)
            {
                Store ("SATA Port1 D0 Entry", Debug)
                And (GP61, 0xFC, GP61)
                Sleep (0x14)
                Store ("SATA Port1 D0 Exit", Debug)
            }

            Method (_PS3, 0, Serialized)
            {
                Store ("SATA Port1 D3 Entry", Debug)
                Or (GP61, 0x01, GP61)
                Store ("SATA Port1 D3 Exit", Debug)
            }
