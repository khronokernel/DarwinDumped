 ...
 * 
 * Disassembly of /Applications/DarwinDumper_v2.8.8/DarwinDumperReports/000_2014-05-26_01-25-55_iMac14,2/DarwinDumper_2.8.8_Apple_X64_Mav_plievasabina/ACPI Tables/AML/DSDT.aml, Mon May 26 01:26:33 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000663B (26171)
 *     Revision         0x03
 *     Checksum         0x05
 *     OEM ID           "APPLE "
 *     OEM Table ID     "iMac"
 *     OEM Revision     0x00410002 (4259842)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20100915 (537921813)
 */
DefinitionBlock ("/Applications/DarwinDumper_v2.8.8/DarwinDumperReports/000_2014-05-26_01-25-55_iMac14,2/DarwinDumper_2.8.8_Apple_X64_Mav_plievasabina/ACPI Tables/AML/DSDT.aml", "DSDT", 3, "APPLE ", "iMac", 0x00410002)
{
    /*
     ...
     */
    External (_SB_.PCI0.DTLK, MethodObj)    // Warning: Unresolved Method, guessing 0 arguments (may be incorrect, see warning above)
    External (_SB_.PCI0.RMCR, MethodObj)    // Warning: Unresolved Method, guessing 0 arguments (may be incorrect, see warning above)
    External (_SB_.PCI0.RMCW, MethodObj)    // Warning: Unresolved Method, guessing 0 arguments (may be incorrect, see warning above)
    ...
    External (_SB_.PCI0.P0P2.GFX0.DID0)
    External (_SB_.PCI0.P0P2.GFX0.VID0)
            ...
            Device (LPCB)
            {
                ...
                Device (EC)
                {
                    ...
                    Method (_Q80, 0, NotSerialized)  // _Qxx: EC Query
                    {
                        ...
                        Store (EGPS, Local0)
                        If (LEqual (\_SB.PCI0.P0P2.GFX0.VID0, 0x10DE))
                        {
                            If (LEqual (\_SB.PCI0.P0P2.GFX0.DID0, 0x0FEA))
                            {
