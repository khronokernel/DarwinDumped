 ...
 * 
 * Disassembly of /tmp/DarwinDumper_2.5.7f_Apple_X64_ML_vadimchumakov/ACPIDump/AML/SSDT-8.aml, Wed Feb 27 11:21:41 2013
 *
...
DefinitionBlock ("/tmp/DarwinDumper_2.5.7f_Apple_X64_ML_vadimchumakov/ACPIDump/AML/SSDT-8.aml", "SSDT", 1, "PmRef", "Cpu0Tst", 0x00003000)
{
    External (TCNT)
    External (CFGD)
    External (_PSS)
