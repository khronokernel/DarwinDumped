 ...
 * 
 * Disassembly of /tmp/DarwinDumper_2.6.5_Apple_X64_ML_alex1960/ACPIDump/AML/DSDT.aml, Mon Mar 18 21:42:46 2013
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00004857 (18519)
 *     Revision         0x03
 *     Checksum         0x45
 *     OEM ID           "APPLE "
 *     OEM Table ID     "iMac"
 *     OEM Revision     0x00310001 (3211265)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20100915 (537921813)
 */

DefinitionBlock ("/tmp/DarwinDumper_2.6.5_Apple_X64_ML_alex1960/ACPIDump/AML/DSDT.aml", "DSDT", 3, "APPLE ", "iMac", 0x00310001)
{
    External (PDC7)
    External (PDC6)
    External (PDC5)
    ...
    External (PDC1)
    External (PDC0)
    External (\_SB_.SDTB, BuffFieldObj)
    ...
    Name (WOWE, 0x00)
    Name (TAPD, 0x00)
    OperationRegion (GNVS, SystemMemory, 0x8CD3EC10, 0x0187)
            ...
            Device (LPCB)
            {
                ...
                Device (EC)
                {
                    ...
                    Method (_Q80, 0, NotSerialized)
                    {
                        ...
                        Else
                        {
                            If (LAnd (LGreater (Local0, 0x03), LLessEqual (Local0, 0x04)))
                            {
                                Notify (\_SB.PCI0.P0P2.GFX0, 0xD2)
                            }

                            If (LAnd (LGreater (Local0, 0x04), LLessEqual (Local0, 0x08)))
                            {
                                Notify (\_SB.PCI0.P0P2.GFX0, 0xD3)
                            }

                            If (LAnd (LGreater (Local0, 0x08), LLessEqual (Local0, 0x10)))
                            {
            ...
            Scope (\_SB.PCI0.RP03)
            {
                ...
                Method (C4PU, 0, Serialized)
                {
                    ...
                    While (0x01)
                    {
                        ...
                        {
                            If (LAnd (LEqual (LACT, 0x01), LAnd (LNotEqual (\_SB.PCI0.RP03.GIGE.AVND, 0xFFFF), 
                                LNotEqual (\_SB.PCI0.RP03.SDXC.AVND, 0xFFFF))))
                            {
                                Store (0x01, Local1)
                                Break
                            }
