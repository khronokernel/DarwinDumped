 ...
 * 
 * Disassembly of /Users/alex/Downloads/DarwinDumper_v2.9.9.2/DarwinDumperReports/000_2016-04-06_20-01-16_MacBook8,1/DarwinDumper_2.9.9.2_Apple_X64_Cap_alex/ACPI Tables/AML/DSDT.aml, Wed Apr  6 20:01:56 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008704 (34564)
 *     Revision         0x03
 *     Checksum         0xD1
 *     OEM ID           "APPLE "
 ...
 */
DefinitionBlock ("/Users/alex/Downloads/DarwinDumper_v2.9.9.2/DarwinDumperReports/000_2016-04-06_20-01-16_MacBook8,1/DarwinDumper_2.9.9.2_Apple_X64_Cap_alex/ACPI Tables/AML/DSDT.aml", "DSDT", 3, "APPLE ", "MacBook", 0x00080001)
{
    /*
        ...
        Device (PCI0)
        {
                ...
                Method (APPD, 0, Serialized)
                {
                    ...
                    If (LEqual (SLTP, 0x00))
                    {
                        ...
                        If (LOr (LEqual (TAPD, 0x00), LEqual (WOWE, 0x01)))
                        {
                            ...
                            Store (And (CKEN, Not (ShiftLeft (0x04, 0x10))), 
                                Local1)
                            Store (Or (ShiftLeft (0x04, 0x18), Local1), Local1)
                ...
                Method (APPU, 0, Serialized)
                {
                    ...
                    If (LEqual (SLTP, 0x00))
                    {
                        If (LOr (LEqual (TAPD, 0x00), LEqual (WOWE, 0x01)))
                        {
                            ...
                            Store (Or (ShiftLeft (0x04, 0x18), ShiftLeft (0x04, 0x10)
                                ), Local1)
                            Store (Or (CKEN, Local1), Local1)
                    ...
                    While (0x01)
                    {
                        ...
                        Sleep (0x96)
                        If (LAnd (LEqual (TAPD, 0x01), LEqual (WOWE, 0x00)))
                        {
                            Store (0x01, GD05)
                        }
            ...
            Scope (\_SB.PCI0.RP05)
            {
                ...
                Device (SSD0)
                {
                    ...
                    Method (_PS3, 0, Serialized)  // _PS3: Power State 3
                    {
                        Store (0x01, \_SB.PCI0.RP05.L23E)
                        Sleep (0x01)
                        Store (0x00, Local0)
                        While (\_SB.PCI0.RP05.L23E)
                        {
                            If (LGreater (Local0, 0x04))
                            {
                                Break
                        ...
                        Store (0x01, \_SB.PCI0.RP05.LEDM)
                        Store (0x03, \_SB.PCI0.RP05.PSTA)
                        Store (0x00, Local0)
                        While (LNotEqual (\_SB.PCI0.RP05.PSTA, 0x03))
                        {
                    ...
                    Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                    {
                        ...
                        Store (0x00, Local0)
                        While (LNotEqual (\_SB.PCI0.RP05.PSTA, 0x00))
                        {
                            If (LGreater (Local0, 0x1388))
                            {
                                Break
                        ...
                        Store (0x01, \_SB.PCI0.RP05.L23D)
                        Sleep (0x01)
                        Store (0x00, Local0)
                        While (LLessEqual (Local0, 0x04))
                        {
                            Store (\_SB.PCI0.RP05.L23D, Local2)
                        ...
                        Store (0x00, \_SB.PCI0.RP05.LEDM)
                        Add (Timer, 0x01C9C380, Local0)
                        Store (0x01, Local1)
                        While (LLessEqual (Timer, Local0))
                        {
                            Store (\_SB.PCI0.RP05.LACT, Local2)
                        ...
                        While (LLessEqual (Timer, Local0))
                        {
                            Store (\_SB.PCI0.RP05.SSD0.CLAS, Local2)
                            If (LEqual (Local2, 0x01))
                            {
                                Store (0x00, Local1)
                                Break
                        ...
                        Store (0x01, \_SB.PCI0.RP05.LTRS)
                        Store (0x01, \_SB.PCI0.RP05.LTRE)
                        Return (Local1)
                    }
                }
            }
                            ...
                            Store (Package (0x1E)
                                {
                                    ...
                                    Buffer (0x08)
                                    {
                                         0x42, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                                    }
                                }, Local0)
                            DTGP (Arg0, Arg1, Arg2, Arg3, RefOf (Local0))
                            Return (Local0)
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If (LNot (OSDW ()))
        {
            If (LEqual (Arg0, 0x03))
            {
                Store (0x01, \_SB.PCI0.LPCB.EC.EWPM)
                \_SB.PCI0.URT0.BLTH.BTPD ()
            }
