 ...
 *
 * Disassembly of /Users/ac/Desktop/DarwinDumper_3.0.4_07.08_11.12.51_MacBook9,1_Apple_X64_Unknown_18A353d_ac/ACPI Tables/AML/DSDT.aml, Tue Aug  7 11:13:16 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008875 (34933)
 *     Revision         0x03
 *     Checksum         0xFC
 *     OEM ID           "APPLE "
...
DefinitionBlock ("", "DSDT", 3, "APPLE ", "MacBook", 0x00080001)
{
    ...
    Name (WOWE, Zero)
    Name (TAPD, Zero)
    OperationRegion (GNVS, SystemMemory, 0x8AF9C918, 0x02C4)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (URT2)
            {
                ...
                Name (DBUF, ResourceTemplate ()
                {
                    FixedDMA (0x0016, 0x0000, Width32bit, )
                    FixedDMA (0x0017, 0x0001, Width32bit, )
                })
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    Return (ConcatenateResTemplate (RBUF, DBUF))
                            ...
                            Local0 = Package (0x1E)
                                {
                                    ...
                                    Buffer (0x08)
                                    {
                                         0x42, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   /* BT...... */
                                    }
                                }
                            DTGP (Arg0, Arg1, Arg2, Arg3, RefOf (Local0))
                            Return (Local0)
