 ...
 * 
 * Disassembly of /Users/Admin1/Downloads/DarwinDumper_v2.9.8/DarwinDumperReports/000_2015-06-06_00-39-16_Macmini7,1/DarwinDumper_2.9.8_Apple_X64_Yos_Admin1/ACPI Tables/AML/DSDT.aml, Sat Jun  6 00:40:48 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00007CDE (31966)
 *     Revision         0x03
 *     Checksum         0x8D
 *     OEM ID           "APPLE "
 ...
 */
DefinitionBlock ("/Users/Admin1/Downloads/DarwinDumper_v2.9.8/DarwinDumperReports/000_2015-06-06_00-39-16_Macmini7,1/DarwinDumper_2.9.8_Apple_X64_Yos_Admin1/ACPI Tables/AML/DSDT.aml", "DSDT", 3, "APPLE ", "Macmini", 0x00070001)
{
    /*
    ...
    External (_SB_.PCI0.CHCL, MethodObj)    // 0 Arguments
    ...
    External (UPC1, MethodObj)    // 0 Arguments
    ...
    Name (WOWE, 0x00)
    Name (TAPD, 0x00)
    OperationRegion (GNVS, SystemMemory, 0x88D3AA90, 0x026D)
        ...
        Device (PCI0)
        {
            ...
            Device (IGPU)
            {
                ...
                Method (GSCI, 0, Serialized)
                {
                    ...
                    Method (SBCB, 0, Serialized)
                    {
                        If (LEqual (GESF, 0x00))
                        {
                            Store ("SBCB Sub Function 0", Debug)
                            Store (0x00, PARM)
                            Store (0x00020000, PARM)
                            Store ("SBCB Sub Function 0 - PARM = ", Debug)
                            Store (PARM, Debug)
                            Store (Zero, GESF)
                            Return (SUCC)
                        }
                        ...
                        {
                            Store (0x00, PARM)
                            Store ("SBCB Sub Function 1", Debug)
                            Store (Zero, GESF)
                            Store (0x00200000, PARM)
                            Store ("SBCB Sub Function 1 - PARM = ", Debug)
                            Store (PARM, Debug)
                            Return (SUCC)
                        }
                        ...
                        If (LEqual (GESF, 0x03))
                        {
                            Store ("SBCB Sub Function 3", Debug)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        }
                        ...
                        If (LEqual (GESF, 0x04))
                        {
                            Store ("SBCB Sub Function 4", Debug)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        }
                        ...
                        If (LEqual (GESF, 0x05))
                        {
                            Store ("SBCB Sub Function 5", Debug)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        }
                        ...
                        If (LEqual (GESF, 0x06))
                        {
                            Store ("SBCB Sub Function 6", Debug)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        }
                        ...
                        If (LEqual (GESF, 0x07))
                        {
                            Store ("SBCB Sub Function 7", Debug)
                            If (LEqual (PARM, 0x00))
                            {
                                Store (CLID, Local0)
                        ...
                        If (LEqual (GESF, 0x08))
                        {
                            Store ("SBCB Sub Function 8", Debug)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        }
                        ...
                        If (LEqual (GESF, 0x09))
                        {
                            Store ("SBCB Sub Function 9", Debug)
                            And (PARM, 0xFF, IBTT)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        ...
                        If (LEqual (GESF, 0x0A))
                        {
                            Store ("SBCB Sub Function 10", Debug)
                            And (PARM, 0xFF, IPSC)
                        ...
                        If (LEqual (GESF, 0x0B))
                        {
                            Store ("SBCB Sub Function 11", Debug)
                        ...
                        If (LEqual (GESF, 0x10))
                        {
                            Store ("SBCB Sub Function 16", Debug)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        }
                        ...
                        If (LEqual (GESF, 0x11))
                        {
                            Store ("SBCB Sub Function 17", Debug)
                        ...
                        If (LEqual (GESF, 0x12))
                        {
                            Store ("SBCB Sub Function 18", Debug)
                            If (And (PARM, 0x01))
                            {
                        ...
                        If (LEqual (GESF, 0x13))
                        {
                            Store ("SBCB Sub Function 19", Debug)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        }
                        ...
                        If (LEqual (GESF, 0x14))
                        {
                            Store ("SBCB Sub Function 20 - Set PAVP Data", Debug)
                            And (PARM, 0x0F, PAVP)
                            Store (Zero, GESF)
                            Store (Zero, PARM)
                            Return (SUCC)
                        ...
                        If (LEqual (GESF, 0x15))
                        {
                            Store ("SBCB Sub Function 21 - Enable/Disable Audio", Debug)
                            Store ("SBCB Sub Function 21 - Audio Enable Bit = ", Debug)
                            Store (\_SB.PCI0.AUDE, Debug)
                            If (LEqual (PARM, 0x01))
                            {
                                Store ("SBCB Sub Function 21 = Enable Audio", Debug)
                                Or (\_SB.PCI0.AUDE, 0x20, \_SB.PCI0.AUDE)
                                Store ("SBCB Sub Function 21 - Audio Enable Bit Updated = ", Debug)
                                Store (\_SB.PCI0.AUDE, Debug)
                                \_SB.PCI0.HDAU.ASTR ()
                                \_SB.PCI0.HDAU.AINI ()
                                \_SB.PCI0.HDAU.CXDC ()
                        ...
                        Store ("SBCB Sub Function UnSupported", Debug)
                        Store (Zero, GESF)
                        Return (SUCC)
                    }
                    ...
                    If (LEqual (GEFC, 0x04))
                    {
                        Store ("GSCI - Calling GBDA()", Debug)
                        Store (GBDA (), GXFC)
                    }

                    If (LEqual (GEFC, 0x06))
                    {
                        Store ("GSCI - Calling SBCB()", Debug)
                        Store (SBCB (), GXFC)
                    }
            ...
            Scope (\_SB.PCI0.RP03)
            {
                ...
                Method (APPD, 0, Serialized)
                {
                    ...
                    Store ("APPD: Put airport module to D3", Debug)
                    ...
                    Store (0x00FEFF00, BNIR)
                    Store (TPEN, Local0)
                    Store ("APPD: Put airport root port to D3", Debug)
                    Store (0x03, PSTA)
                    Store (TPEN, Local0)
                    Store (0x01, LDIS)
                    Add (Timer, 0x00989680, Local0)
                ...
                Method (APPU, 0, Serialized)
                {
                    ...
                    Store ("APPU: Restore airport root port back to D0", Debug)
                    Store (0x00, PSTA)
                    If (LNotEqual (SECB, 0xFF))
                    {
                        Store ("APPU: Valid config, no restore needed", Debug)
                        WAPS ()
                        Return (Zero)
                    }
                    ...
                    While (0x01)
                    {
                        Store ("APPU: Restore Power", Debug)
                ...
                Method (WAPS, 0, Serialized)
                {
                    ...
                    Store (0x013B106B, \_SB.PCI0.RP03.ARPT.BDDR)
            ...
            Scope (\_SB.PCI0.RP06)
            {
                ...
                Method (TSSD, 0, Serialized)
                {
                    ...
                    While (LLessEqual (Timer, Local0))
                    {
                        ...
                        {
                            Store (0x00, Local1)
                            Store ("SSD Work Around in Effect.", Debug)
                            While (LNotEqual (LSPD, 0x02))
                            {
                                Store ("SSD is not at Gen2, attempting to retrain link.", Debug)
                                Store (0x01, LRTN)
                                Store (0x00, Local2)
                                While (LOr (LNotEqual (LACT, 0x01), LEqual (LTRN, 0x01)))
                                {
                                    ...
                                    {
                                        Store ("SSD link did not come back up in time after retrain. LACT:", Debug)
                                        Store (LACT, Debug)
                                        Store ("LTRN: ", Debug)
                                        Store (LTRN, Debug)
                                        Break
                                ...
                                {
                                    Store ("SSD did not retrain to Gen2 within the max # of retries.", Debug)
                                    Break
                                }
    ...
    Method (DSPI, 0, Serialized)
    {
        If (LNot (OSDW ()))
        {
            Store ("Disable SPI Devices", Debug)
            Store (0x03, S0D3)
            Store (IOSR, Local0)
            ...
            If (LEqual (Local1, 0x00))
            {
                Store ("Iobp Write: SUCCESS", Debug)
            }
    ...
    Scope (\_SB.PCI0)
    {
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
            ...
            Store ("OSYS=", Debug)
            Store (OSYS, Debug)
            Store (\_SB.PCI0.LPCB.RTC.ISWI, Debug)
            If (LNot (OSDW ()))
            {
                If (LGreaterEqual (OSYS, 0x07DC))
                {
                    Store ("Save Ridge Config on Boot", Debug)
                    Store (UP18, R118)
                    Store (UP19, R119)
                    Store (UP1A, R11A)
                    Store (UP1C, R11C)
                    ...
                    {
                        Store ("Enable ICM on Boot", Debug)
                        \_SB.PCI0.WTLT ()
                        \_SB.PCI0.CNHI ()
                        Store (0x06, ICME)
                        Sleep (0x01)
                    ...
                    Else
                    {
                        Store ("Windows Installation", Debug)
                    }

                    Store (0x00, GP47)
                    Store (0x00, GD47)
                    Store ("Enable ICM on Boot, Complete", Debug)
                }
            }
            ...
            If (LNot (OSDW ()))
            {
                If (LLess (OSYS, 0x07DC))
                {
                    Store ("RMCR Method called:", Debug)
                    \_SB.PCI0.RMCR ()
                }
                Else
                {
                    Store ("RMCR skipped", Debug)
                }
            }
        }
        ...
        Method (TBMB, 1, Serialized)
        {
            ...
            While (0x01)
            {
                ...
                Store (T2PR, Local1)
                If (LEqual (And (Local1, 0x01, Local2), 0x01))
                {
                    Break
                }
    ...
    Scope (\_GPE)
    {
        ...
        {
            Store ("GPE0_TCO_SCI_HANDLER - GFX Software SCI Event", Debug)
            Store ("GSSE value = ", Debug)
            Store (\_SB.PCI0.IGPU.GSSE, Debug)
            Store ("GSMI value = ", Debug)
            Store (GSMI, Debug)
            Store ("SCIS value = ", Debug)
            Store (SCIS, Debug)
            Store ("Entry function code = ", Debug)
            Store (\_SB.PCI0.IGPU.GEFC, Debug)
            If (LAnd (\_SB.PCI0.IGPU.GSSE, LNot (GSMI)))
            {
                Store ("GPE0_TCO_SCI_HANDLER - Calling IGPU.GSCI() Method", Debug)
                \_SB.PCI0.IGPU.GSCI ()
            }
            Else
            {
                Store ("GPE0_TCO_SCI_HANDLER - Not a GFX SW SCI Event", Debug)
        ...
        Name (ICMM, 0x00)
        Method (_L52, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            If (LNot (OSDW ()))
            {
                If (LGreaterEqual (OSYS, 0x07DC))
                {
                    ...
                    Store (" Call ICM Plug Event", Debug)
                    \_SB.PCI0.CMPE ()
                }
            }
            Else
        ...
        Method (_L4D, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            {
                Store (0x00, GI77)
                Store ("GPE0_TBT_PWR_REQ_HANDLER: Interrupt GP_INV = 1, Changing to 0", Debug)
            }
            Else
            {
                Store (0x01, GI77)
                Store ("GPE0_TBT_PWR_REQ_HANDLER: Interrupt GP_INV = 0, Changing to 1", Debug)
            }
            ...
            If (LNot (OSDW ()))
            {
                If (LGreaterEqual (OSYS, 0x07DC))
                {
                    ...
                    If (LEqual (\_SB.PCI0.UPCK (), 0x00))
                    {
                        Store ("GPE0_TBT_PWR_REQ_HANDLER Thunderbolt device not connected", Debug)
                        Store (0x01, EICM)
                        \_SB.PCI0.CMPE ()
                    }
                }
    ...
    Scope (\_SB.PCI0)
    {
        Device (HDAU)
        {
            ...
            {
                Store ("ASTR Method Called", Debug)
            ...
            {
                Store ("VSTR Method Called", Debug)
                Name (CONT, 0x03E8)
            ...
            {
                Store ("CXDC Method Called", Debug)
            ...
            {
                Store ("AINI Method Called", Debug)
                Name (CONT, 0x03E8)
                If (LAnd (LNotEqual (ABAR, 0xFFFFFFFF), LNotEqual (And (ABAR, 
                    0xFFFFC000), 0x00)))
                {
