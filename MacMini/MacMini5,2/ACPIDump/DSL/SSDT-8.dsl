 ...
 * 
 * Disassembly of /tmp/DarwinDumper_2.5.7f_Apple_X64_ML_wisevov/ACPIDump/AML/SSDT-8.aml, Mon Mar 18 21:04:42 2013
 *
...
DefinitionBlock ("/tmp/DarwinDumper_2.5.7f_Apple_X64_ML_wisevov/ACPIDump/AML/SSDT-8.aml", "SSDT", 1, "PmRef", "Cpu0Tst", 0x00003000)
{
    External (TCNT)
    External (CFGD)
    External (_PSS)
