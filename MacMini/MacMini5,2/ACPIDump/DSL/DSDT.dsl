 ...
 * 
 * Disassembly of /tmp/DarwinDumper_2.5.7f_Apple_X64_ML_wisevov/ACPIDump/AML/DSDT.aml, Mon Mar 18 21:04:42 2013
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000500C (20492)
...
DefinitionBlock ("/tmp/DarwinDumper_2.5.7f_Apple_X64_ML_wisevov/ACPIDump/AML/DSDT.aml", "DSDT", 1, "APPLE ", "Macmini", 0x00050001)
{
    External (PDC7)
    External (PDC6)
    External (PDC5)
    ...
    Name (WOWE, 0x00)
    Name (TAPD, 0x00)
    OperationRegion (GNVS, SystemMemory, 0x8ED50C10, 0x0178)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (RP03)
            {
                ...
                Method (RPEA, 0, Serialized)
                {
                    Store (0x03, ASPM)
                }

                Method (RPDA, 0, Serialized)
                {
                    Store (0x00, ASPM)
                }
                ...
                {
                    Name (_ADR, 0x00)
                    OperationRegion (FWBC, PCI_Config, 0xA0, 0x02)
                    Field (FWBC, WordAcc, NoLock, Preserve)
                    {
                        ASPM,   2
                    }

                    Method (FBEA, 0, Serialized)
                    {
                        RPEA ()
                        Store (0x03, ASPM)
                    }

                    Method (FBDA, 0, Serialized)
                    {
                        Store (0x00, ASPM)
                        RPDA ()
                    }
