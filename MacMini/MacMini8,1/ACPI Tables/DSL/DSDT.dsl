 ...
 *
 * Disassembly of /Applications/DarwinDumper_3.0.4_30.04_22.35.17_Macmini8,1_Apple_X64_Unknown_18E226_gen4ig/ACPI Tables/AML/DSDT.aml, Tue Apr 30 22:35:37 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000701C (28700)
 *     Revision         0x02
 *     Checksum         0xFF
 *     OEM ID           "APPLE "
 *     OEM Table ID     "Mac mini"
 *     OEM Revision     0x00010001 (65537)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20160930 (538315056)
 */
DefinitionBlock ("", "DSDT", 2, "APPLE ", "Mac mini", 0x00010001)
{
    ...
    Name (WOWE, Zero)
    Name (TAPD, Zero)
    OperationRegion (GNVS, SystemMemory, 0x78F34E18, 0x0185)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
                ...
                Device (GIGE)
                {
                    ...
                    Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
                    {
                        ...
                        Else
                        {
                            ...
                            If (Arg0 == ToUUID ("a0b5b7c6-1318-441c-b0c9-fe695eaf949b"))
                            {
                                Local0 = GBU1 /* \_SB_.PCI0.RP02.GIGE._DSM.GBU1 */
                                DTGP (Arg0, Arg1, Arg2, Arg3, RefOf (Local0))
                                Return (Local0)
                            }
                        }
            ...
            Scope (PEG0)
            {
                ...
                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                {
                    Return (SECB) /* \_SB_.PCI0.PEG0.SECB */
                }
                ...
                Device (XGBE)
                {
                    ...
                    Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
                    {
                        ...
                        Else
                        {
                            ...
                            If (Arg0 == ToUUID ("a0b5b7c6-1318-441c-b0c9-fe695eaf949b"))
                            {
                                Local0 = GBU1 /* \_SB_.PCI0.PEG0.XGBE._DSM.GBU1 */
                                DTGP (Arg0, Arg1, Arg2, Arg3, RefOf (Local0))
                                Return (Local0)
                            }
                        }
