 ...
 *
 * Disassembly of /Users/samslesarev/Desktop/DarwinDumper_3.0.3_12.08_17.31.12_MacBookPro13,3_Apple_X64_Sierra_16F73_samslesarev/ACPI Tables/AML/SSDT-6.aml, Sat Aug 12 17:31:33 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000B494 (46228)
 *     Revision         0x02
 *     Checksum         0xE0
 *     OEM ID           "APPLE "
    ...
    Scope (\_SB.PCI0)
    {
        Scope (\_SB.PCI0.PEG1)
        {
            ...
            Method (CTBT, 0, Serialized)
            {
                ...
                {
                    If ((GGDV (0x01070004) == One) && (\_SB.PCI0.PEG1.UPSB.AVND != 0xFFFFFFFF))
                    {
        ...
        Scope (\_SB.PCI0.PEG2)
        {
            Scope (\_GPE)
            {
                Method (_L56, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
                {
                    If (!OSDW ())
                    {
                    ...
                    ElseIf (\_SB.GGII (0x01070016) == One)
                    {
            ...
            Method (CTBT, 0, Serialized)
            {
                ...
                {
                    If ((GGDV (0x01070005) == One) && (\_SB.PCI0.PEG2.UPSB.AVND != 0xFFFFFFFF))
                    {
            ...
            {
                Local0 = Zero
                If ((GGOV (0x01070005) == Zero) && (GGDV (0x01070005) == Zero))
                {
                    \_SB.PCI0.PEG2.PSTA = Zero
                    While (One)
                    {
            ...
            Device (UPSB)
            {
                ...
                Method (CRMW, 5, Serialized)
                {
                    ...
                    If (\_SB.PCI0.PEG2.PUPS != Zero)
                    {
                        If (((GGDV (0x01070005) == One) || (GGDV (0x01070008) == One)) && 
                            (\_SB.PCI0.PEG2.UPSB.AVND != 0xFFFFFFFF))
                        {
                            Local3 = Zero
                            While (Local3 <= 0x04)
