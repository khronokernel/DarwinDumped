 ...
 *
 * Disassembly of /Users/keokereokeke/Documents/DarwinDumper_3.0.3_08.10_15.53.02_MacBookPro14,1_Apple_X64_Unknown_17A405_keokereokeke/ACPI Tables/AML/DSDT.aml, Sun Oct  8 15:53:23 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008F41 (36673)
 *     Revision         0x02
 *     Checksum         0x59
 *     OEM ID           "APPLE "
 *     OEM Table ID     "MacBookP"
 *     OEM Revision     0x00140001 (1310721)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20140424 (538182692)
 */
DefinitionBlock ("", "DSDT", 2, "APPLE ", "MacBookP", 0x00140001)
{
    /*
    ...
    Name (WOWE, Zero)
    Name (TAPD, Zero)
    OperationRegion (GNVS, SystemMemory, 0x88F7E918, 0x02CD)
        ...
        Device (PCI0)
        {
            ...
            Device (IGPU)
            {
                ...
                Method (SBCB, 0, Serialized)
                {
                    If (GESF == Zero)
                    {
                        Debug = "SBCB Sub Function 0"
                        PARM = Zero
                        PARM = 0x00020000
                        Debug = "SBCB Sub Function 0 - PARM = "
                        Debug = PARM /* \_SB_.PCI0.IGPU.PARM */
                        GESF = Zero
                        Return (SUCC) /* \_SB_.PCI0.IGPU.SUCC */
                    }
                    ...
                    {
                        PARM = Zero
                        Debug = "SBCB Sub Function 1"
                        GESF = Zero
                        PARM = 0x00200000
                        Debug = "SBCB Sub Function 1 - PARM = "
                        Debug = PARM /* \_SB_.PCI0.IGPU.PARM */
                        Return (SUCC) /* \_SB_.PCI0.IGPU.SUCC */
                    }
                    ...
                    If (GESF == 0x14)
                    {
                        Debug = "SBCB Sub Function 20 - Set PAVP Data"
                        PAVP = (PARM & 0x0F)
                        GESF = Zero
                        PARM = Zero
                        Return (SUCC) /* \_SB_.PCI0.IGPU.SUCC */
                    ...
                    If (GESF == 0x15)
                    {
                        Debug = "SBCB Sub Function 21 - Enable/Disable Audio"
                        Debug = "SBCB Sub Function 21 - Audio Enable Bit = "
                        Debug = AUDE /* \_SB_.PCI0.AUDE */
                        If (PARM == One)
                        {
                            Debug = "SBCB Sub Function 21 = Enable Audio"
                            AUDE |= 0x20
                            Debug = "SBCB Sub Function 21 - Audio Enable Bit Updated = "
                            Debug = AUDE /* \_SB_.PCI0.AUDE */
                    ...
                    Debug = "SBCB Sub Function UnSupported"
                    GESF = Zero
                    Return (SUCC) /* \_SB_.PCI0.IGPU.SUCC */
                }
                ...
                Method (GSCI, 0, Serialized)
                {
                    ...
                    If (GEFC == 0x04)
                    {
                        Debug = "GSCI - Calling GBDA()"
                        GXFC = GBDA ()
                    }

                    If (GEFC == 0x06)
                    {
                        Debug = "GSCI - Calling SBCB()"
                        GXFC = SBCB ()
                    }
            ...
            Scope (RP10)
            {
                ...
                {
                    Name (_ADR, Zero)  // _ADR: Address
                    OperationRegion (ARE3, PCI_Config, Zero, 0xFF)
                    ...
                    Method (CMPE, 1, Serialized)
                    {
                        ...
                        If (Arg0 <= One)
                        {
                            If (Arg0 == One)
                            {
                                SGDI (0x02000010)
                                Sleep (0x64)
                                ASPM = S2PM /* \_SB_.PCI0.RP10.CMRA.S2PM */
                                PSTA = Zero
                                While (PSTA != Zero)
                                {
                                    Sleep (One)
                ...
                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                {
                    Return (SECB) /* \_SB_.PCI0.RP10.SECB */
                }
            ...
            Scope (RP01)
            {
                ...
                Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                {
                    ...
                    If (NVME != One)
                    {
                        ...
                        Local2 = ^SSD0.SVID /* \_SB_.PCI0.RP01.SSD0.SVID */
                        Local3 = ^SSD0.SDID /* \_SB_.PCI0.RP01.SSD0.SDID */
            ...
            Scope (SPI1)
            {
                Device (SPIT)
                {
                    ...
                    Method (SIEN, 1, Serialized)
                    {
                        ...
                        If (Local0)
                        {
                            Debug = "TPAD_SPI_IF_EN has pull-up"
                        }
                        Else
                        {
                            Debug = "TPAD_SPI_IF_EN has pull-down"
                        }
                    ...
                    Method (SIST, 0, Serialized)
                    {
                        ...
                        If (Local0 == One)
                        {
                            ...
                            Debug = "GGIV of SIST PLATFORM_ACPI_SPIT_SPI_IF_INPUT_STATE: "
                            Debug = Local0
                        ...
                        Else
                        {
                            ...
                            Debug = "GGOV of SIST PLATFORM_ACPI_SPIT_SPI_IF_INPUT_STATE: "
                            Debug = Local0
    ...
    Scope (_GPE)
    {
        ...
        {
            Debug = "GPE0_TCO_SCI_HANDLER - GFX Software SCI Event"
            Debug = "GSSE value = "
            Debug = \_SB.PCI0.IGPU.GSSE
            Debug = "GSMI value = "
            Debug = GSMI /* \GSMI */
            Debug = "SCIS value = "
            Debug = SCIS /* \SCIS */
            Debug = "Entry function code = "
            Debug = \_SB.PCI0.IGPU.GEFC
            If (\_SB.PCI0.IGPU.GSSE && !GSMI)
            {
                Debug = "GPE0_TCO_SCI_HANDLER - Calling IGPU.GSCI() Method"
                \_SB.PCI0.IGPU.GSCI ()
            }
            Else
            {
                Debug = "GPE0_TCO_SCI_HANDLER - Not a GFX SW SCI Event"
        ...
        Method (_L69, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            \_SB.PCI0.TGPE ()
            Notify (\_SB.PCI0.RP09.ARPT, 0x02) // Device Wake
        }
        ...
        Method (_L6F, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            If ((Local0 & 0x04) && (Local1 & 0x04))
            {
                ...
                Debug = "SMC_WAKE_SCI GPD2 status bit cleared"
            }
        }
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If (OSDW ())
        {
            If (Arg0 == 0x04)
            {
                Debug = "S4: Set TPAD_SPI_IF_EN low"
                \_SB.SGOV (0x02000016, Zero)
                \_SB.SGDO (0x02000016)
            }
        }
        ...
        If (!OSDW ())
        {
            ...
            {
                Local0 = Zero
                While ((\_SB.PCI0.RP10.CMRA.DPST != 0x03) && (Local0 < 0x1388))
                {
                    Sleep (One)
                    Local0++
                }

                \_SB.PCI0.RP10.CMRA.CMPE (Zero)
            }
        }
        ...
        Debug = "^^^ Quiesce PCH UART0 TXD"
        Debug = Arg0
        \_SB.SGDI (0x02020009)
        \_SB.SPMV (0x02020009, Zero)
    ...
    Method (_WAK, 1, NotSerialized)  // _WAK: Wake
    {
        ...
        ElseIf (Arg0 == 0x03)
        {
            \_SB.PCI0.RP10.CMRA.CMPE (One)
        }

        LIDS = \_SB.PCI0.LPCB.EC.ELSW
        Debug = "LidState - ELSW ="
        Debug = \_SB.PCI0.LPCB.EC.ELSW
        \_SB.PCI0.IGPU.CLID = \_SB.PCI0.LPCB.EC.ELSW
        Debug = "LidState - CLID ="
        Debug = \_SB.PCI0.IGPU.CLID
        If (!OSDW ())
        {
            \_SB.PTOP ()
        }
