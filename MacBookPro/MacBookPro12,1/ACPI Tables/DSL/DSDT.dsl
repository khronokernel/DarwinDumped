 ...
 * 
 * Disassembly of /Users/vovando/Desktop/DarwinDumper_3.0.1_04.11_00.50.19_MacBookPro12,1_Apple_X64_Sierra_16B2555_vovando/ACPI Tables/AML/DSDT.aml, Fri Nov  4 00:50:41 2016
 *
 ...
 */
DefinitionBlock ("/Users/vovando/Desktop/DarwinDumper_3.0.1_04.11_00.50.19_MacBookPro12,1_Apple_X64_Sierra_16B2555_vovando/ACPI Tables/AML/DSDT.aml", "DSDT", 3, "APPLE ", "MacBookP", 0x00010000)
{
    /*
                ...
                Device (SSD0)
                {
                    ...
                    Method (_PS3, 0, Serialized)  // _PS3: Power State 3
                    {
                        If (LAnd (OSDW (), NVME))
                        {
                            ...
                            If (LEqual (SLTP, 0x00))
                            {
                                Store (0x03, \_SB.PCI0.RP06.PSTA)
                                Store (0x00, Local0)
                                While (LNotEqual (\_SB.PCI0.RP06.PSTA, 0x03))
                                {
                    ...
                    Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                    {
                        If (LAnd (OSDW (), NVME))
                        {
                            ...
                            Store (0x01, GD38)
                            Sleep (0x01)
                            Store (0x00, \_SB.PCI0.RP06.PSTA)
                            Store (0x00, Local0)
                            While (LNotEqual (\_SB.PCI0.RP06.PSTA, 0x00))
                            {
                                If (LGreater (Local0, 0x1388))
                                {
                                    Break
                            ...
                            Store (0x01, \_SB.PCI0.RP06.L23D)
                            Sleep (0x01)
                            Store (0x00, Local0)
                            While (LLessEqual (Local0, 0x04))
                            {
                                Store (\_SB.PCI0.RP06.L23D, Local2)
                            ...
                            While (LLessEqual (Timer, Local0))
                            {
                                Store (\_SB.PCI0.RP06.LACT, Local2)
                            ...
                            While (LLessEqual (Timer, Local0))
                            {
                                Store (\_SB.PCI0.RP06.SSD0.CLAS, Local2)
                                If (LEqual (Local2, 0x01))
                                {
                                    Store (0x00, Local1)
                                    Break
                            ...
                            Store (0x01, \_SB.PCI0.RP06.LTRS)
                            Store (0x01, \_SB.PCI0.RP06.LTRE)
                        }
                    ...
                    If (LEqual (LAnd (OSDW (), NVME), 0x00))
                    {
                        If (OSDW ())
                        {
                            If (LEqual (SLTP, 0x00))
                            {
                                ...
                                Store (Or (ShiftLeft (0x20, 0x10), ShiftLeft (0x20, 0x18)
                                    ), Local1)
                                Store (Or (CKEN, Local1), Local1)
                                Or (Local1, 0x04, Local1)
                                Store (Local1, CKEN)
                        ...
                        While (LLessEqual (Timer, Local0))
                        {
                            If (LAnd (LEqual (LACT, 0x01), LEqual (\_SB.PCI0.RP06.SSD0.CLAS, 0x01)))
                            {
                                Break
                            }
                    ...
                    If (LEqual (LAnd (OSDW (), NVME), 0x00))
                    {
                        ...
                        If (OSDW ())
                        {
                            If (LEqual (SLTP, 0x00))
                            {
                                ...
                                Store (And (CKEN, Not (ShiftLeft (0x20, 0x10))), 
                                    Local1)
                                Store (Or (ShiftLeft (0x20, 0x18), Local1), Local1)
                                Store (Or (Local1, 0x04), Local1)
                                Store (Local1, CKEN)
                                Store (0x00, Local0)
                                While (LEqual (PMFS, 0x01))
