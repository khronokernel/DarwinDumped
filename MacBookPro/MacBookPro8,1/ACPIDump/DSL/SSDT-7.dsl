 ...
 * 
 * Disassembly of /tmp/DarwinDumper_2.5.7f_Apple_X64_ML_RainbowDash/ACPIDump/AML/SSDT-7.aml, Mon Mar  4 21:45:16 2013
 *
...
DefinitionBlock ("/tmp/DarwinDumper_2.5.7f_Apple_X64_ML_RainbowDash/ACPIDump/AML/SSDT-7.aml", "SSDT", 1, "PmRef", "Cpu0Tst", 0x00003000)
{
    External (TCNT)
    External (CFGD)
    External (_PSS)
